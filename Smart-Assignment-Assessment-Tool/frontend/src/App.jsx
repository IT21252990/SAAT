    ...
    <section className="bg-white dark:bg-gray-900 h-screen">
      ...
      <div className="mx-auto grid max-w-screen-xl px-4 py-8 lg:grid-cols-12 lg:gap-8 lg:py-16 xl:gap-0">
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <p className="mb-6 mt-10 max-w-2xl font-light text-gray-500 dark:text-gray-400 md:text-lg lg:mb-8 lg:text-xl">
          Smart Assignment Assessment Tool<br></br>An automated platform for easy submission and assessment of student coursework
          </p>
          <button
