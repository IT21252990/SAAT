...
//         <Header />
//       </div>
//       <section className="w-full h-screen p-6 mx-auto bg-white shadow-md dark:bg-gray-800">
//         <div className="grid max-w-screen-xl px-4 mx-auto lg:grid-cols-12 lg:gap-8 xl:gap-0">
//           <div className="mr-auto place-self-center lg:col-span-7">
//             <h1 className="max-w-2xl mt-10 mb-10 text-4xl font-extrabold leading-none tracking-tight dark:text-white md:text-5xl xl:text-6xl">
//               Welcome to S A A T
//             </h1>
//             <p className="max-w-2xl mt-10 mb-6 font-semibold text-gray-500 dark:text-gray-400 md:text-lg lg:mb-8 lg:text-xl">
...
//                 className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-primary-300 dark:focus:ring-primary-900 focus:ring-4"
//               >
//                 Login
//                 <svg
...
//             </div>
//           </div>
//           <div className="items-center justify-center hidden lg:col-span-5 lg:flex">
...
//       <section className="flex-grow w-full p-6 mx-auto shadow-lg">
...
//             <h1 className="max-w-2xl mb-6 text-4xl font-extrabold leading-none tracking-tight text-gray-900 dark:text-white md:text-5xl xl:text-6xl">
//               Welcome to <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-700 to-primary-500">SAAT</span>
//             </h1>
            
//             <p className="max-w-2xl mb-6 font-semibold text-gray-500 dark:text-gray-400 md:text-lg lg:mb-8 lg:text-xl">
//               Smart Assignment Assessment Tool
//             </p>
            
//             <p className="max-w-2xl mb-8 text-gray-600 dark:text-gray-300 md:text-lg">
//               Tool is designed to automate and enhance the evaluation process for various student submissions, including reports, Code files, GitHub repositories, and videos.
//               This system benefits both students and educators by streamlining submission, review, and feedback processes, ultimately improving the educational experience.
//             </p>
...
//               <div className="flex -space-x-4">
//                 {[1, 2, 3, 4].map((i) => (
//                   <div key={i} className={`flex items-center justify-center w-10 h-10 text-xs font-bold text-white border-2 border-white rounded-full dark:border-gray-800 bg-primary-${i*100}`}>
//                     {["S", "A", "A", "T"][i-1]}
//                   </div>
//                 ))}
//               </div>
...
//         <div className="max-w-screen-xl px-4 py-8 mx-auto mt-8">
//           <h2 className="mb-8 text-2xl font-bold text-center text-gray-900 dark:text-white">Our Assessment Capabilities</h2>
...
//                 </svg>
//               </div>
//               <h3 className="mb-2 text-xl font-bold text-gray-800 dark:text-white">Coding Assignments Assessment</h3>
//               <p className="text-gray-600 dark:text-gray-400">Automatically analyze code submissions for correctness, efficiency, and style adherence</p>
//             </div>
//             <div className="p-6 transition-all duration-300 bg-white rounded-lg shadow-md dark:bg-gray-800 hover:shadow-lg hover:transform hover:scale-105">
//               <div className="w-12 h-12 p-3 mx-auto mb-4 rounded-full bg-primary-100 dark:bg-primary-900">
//                 <svg className="w-6 h-6 text-primary-600 dark:text-primary-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
...
//                 </svg>
//               </div>
//               <h3 className="mb-2 text-xl font-bold text-gray-800 dark:text-white">Video Assignments Review</h3>
//               <p className="text-gray-600 dark:text-gray-400">Evaluate video presentations with intelligent feedback on content, delivery, and engagement</p>
//             </div>
//             <div className="p-6 transition-all duration-300 bg-white rounded-lg shadow-md dark:bg-gray-800 hover:shadow-lg hover:transform hover:scale-105">
//               <div className="w-12 h-12 p-3 mx-auto mb-4 rounded-full bg-primary-100 dark:bg-primary-900">
//                 <svg className="w-6 h-6 text-primary-600 dark:text-primary-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
...
//                 </svg>
//               </div>
//               <h3 className="mb-2 text-xl font-bold text-gray-800 dark:text-white">Project Reports Evaluation</h3>
//               <p className="text-gray-600 dark:text-gray-400">Automate assessment of written reports with focus on structure, content, and academic standards</p>
//             </div>
//             <div className="p-6 transition-all duration-300 bg-white rounded-lg shadow-md dark:bg-gray-800 hover:shadow-lg hover:transform hover:scale-105">
//               <div className="w-12 h-12 p-3 mx-auto mb-4 rounded-full bg-primary-100 dark:bg-primary-900">
//                 <svg className="w-6 h-6 text-primary-600 dark:text-primary-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
...
//                 </svg>
//               </div>
//               <h3 className="mb-2 text-xl font-bold text-gray-800 dark:text-white">Viva Questions Generation</h3>
//               <p className="text-gray-600 dark:text-gray-400">Generate relevant questions for oral examinations based on submitted work</p>
//             </div>
//           </div>
//         </div>
        
//         <div className="max-w-screen-xl px-4 py-8 mx-auto mt-6">
//           <div className="p-6 rounded-lg bg-gradient-to-r from-primary-50 to-blue-50 dark:from-gray-800 dark:to-gray-700">
//             <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
//               <div>
//                 <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Ready to transform your assessment workflow?</h2>
//                 <p className="mt-2 text-gray-600 dark:text-gray-300">Join educators who are saving time and providing better feedback.</p>
//               </div>
//               <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
//                 <button
//                   onClick={() => navigate("/register")}
//                   className="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-white rounded-lg bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900"
//                 >
...
//         <div className="absolute inset-0 bg-blue-600 bg-grid-pattern dark:bg-blue-400"></div>
//       </div>
      
//       {/* Background Gradient Overlay */}
//       <div className="absolute inset-0 z-0 bg-gradient-to-br from-white via-blue-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 opacity-90"></div>
...
//       <section className="relative z-10 flex-grow w-full p-6 mx-auto">
//         <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:grid-cols-12 lg:gap-8 xl:gap-0">
//           <div className={`mr-auto place-self-center lg:col-span-7 transition-all duration-1000 ease-in-out ${isVisible ? 'opacity-100' : 'opacity-0 -translate-x-10'}`}>
//             <div className="inline-flex items-center px-4 py-2 mb-6 text-sm font-medium rounded-full text-primary-700 bg-primary-100 dark:bg-primary-900 dark:text-primary-300">
//               <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
...
//           <h2 className="mb-8 text-2xl font-bold text-center text-gray-900 dark:text-white">Our Assessment Capabilities</h2>
//           <div className="grid grid-cols-1 gap-6 text-center sm:grid-cols-2 lg:grid-cols-4">
//             <div className="p-6 transition-all duration-300 rounded-lg shadow-md bg-white/90 dark:bg-gray-800/90 hover:shadow-lg hover:transform hover:scale-105">
//               <div className="w-12 h-12 p-3 mx-auto mb-4 rounded-full bg-primary-100 dark:bg-primary-900">
//                 <svg className="w-6 h-6 text-primary-600 dark:text-primary-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
//                   <path fillRule="evenodd" d="M12.316 3.051a1 1 0 01.633 1.265l-4 12a1 1 0 11-1.898-.632l4-12a1 1 0 011.265-.633zM5.707 6.293a1 1 0 010 1.414L3.414 10l2.293 2.293a1 1 0 11-1.414 1.414l-3-3a1 1 0 010-1.414l3-3a1 1 0 011.414 0zm8.586 0a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 11-1.414-1.414L16.586 10l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd"></path>
//                 </svg>
        ...
        <div className="max-w-screen-xl px-4 py-12 mx-auto mt-12">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
            ...
            <div className="p-4 text-center bg-white rounded-lg shadow-md dark:bg-gray-800">
              ...
              <p className="font-medium text-gray-800 dark:text-white">Static Analysis</p>
            </div>
            <div className="p-4 text-center bg-white rounded-lg shadow-md dark:bg-gray-800">
              <svg className="w-8 h-8 mx-auto mb-2 text-primary-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path d="M2 6a2 2 0 012-2h6a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V6zM14.553 7.106A1 1 0 0014 8v4a1 1 0 00.553.894l2 1A1 1 0 0018 13V7a1 1 0 00-1.447-.894l-2 1z"></path>
