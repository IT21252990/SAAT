          ...
          {assignments.length > 0 ? (
            assignments.map((assignment) => (
              <div
                ...
                className="block max-w-sm cursor-pointer rounded-lg border border-gray-200 bg-gray-200 p-6 shadow-sm hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600"
              >
