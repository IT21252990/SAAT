  ...
  return (
    <div className="flex h-screen flex-col">
      ...
      <section className="flex-grow bg-gray-50 dark:bg-gray-900">
        <div className="mx-auto mt-10 flex flex-col items-center justify-center px-6 py-2 lg:py-0">
        <h1 className="mx-auto mb-5 flex items-center text-center text-2xl font-semibold text-gray-900 dark:text-white">
                &nbsp;&nbsp;Welcome Back !
              </h1>
          <div className="w-full rounded-lg bg-white shadow dark:border dark:border-gray-700 dark:bg-gray-800 sm:max-w-md md:mt-0 xl:p-0">
            
            <div className="space-y-4 p-2 sm:p-8 md:space-y-6">
              ...
              <form className="space-y-4 md:space-y-3" onSubmit={handleLogin}>
                ...
                <hr className="my-1 h-px w-full border-0 bg-gray-200 dark:bg-gray-700  dark:bg-opacity-80" />
                <button
                  onClick={handleGoogleLogin}
                  className="flex w-full items-center justify-center gap-x-3 rounded-lg border py-2.5 text-sm font-medium text-black dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                >
                  <svg
