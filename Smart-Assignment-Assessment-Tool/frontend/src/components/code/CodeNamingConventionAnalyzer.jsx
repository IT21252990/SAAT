...
const CodeNamingConventionAnalyzer = ({ github_url, code_id }) => {
  ...
  const analyzeCodeNaming = async () => {
    ...
    try {
      ...
      clearInterval(progressInterval);
      setProgress(100);
      // Fix: Access the results property of the response data
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
      <div className="flex justify-between items-center mb-4">
        ...
        >
          ...
          {isAnalyzing ? 'Analyzing...' : 'Analyze Code Naming'}
        </Button>
      </div>
            ...
            <div>
              <Alert color="warning" className="mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    Found {results.issues.length} {results.issues.length === 1 ? 'issue' : 'issues'} with code naming conventions.
                  </span>
                </div>
              </Alert>
              {renderIssuesList()}
